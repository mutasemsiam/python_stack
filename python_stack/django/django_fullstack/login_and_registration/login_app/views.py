...
def show(request):
    ...
    if 'case' not in request.session:
        return redirect("/") 
...
def register(request):
    ...
    logged_user = user[0]
    request.session['user_id'] = logged_user.first_name + " " + logged_user.last_name
    request.session['case'] = 'registration'
